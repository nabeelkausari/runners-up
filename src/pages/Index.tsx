...
const Index = () => {
  ...
  const newArrivals = [...allProducts]
    ...
    .map(product => ({
      ...product,
      isNew: true,
      originalPrice: Math.round(product.currentPrice * (1.1 + Math.random() * 0.4))
    }));
        ...
        <div className="container mx-auto flex flex-col lg:flex-row items-center justify-between">
          <div className="lg:w-1/2 animate-fade-up">
            ...
            <p className="text-gray-600 mb-8 text-lg">
              Discover our exquisite collection of handcrafted miniatures, DIY kits, and expert workshops.
              Perfect for hobbyists, collectors, and creative minds of all skill levels.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-amber-900/80">
              We bring your miniature dreams to life with premium quality materials and expert craftsmanship.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Handcrafted Quality</h3>
              <p className="text-gray-600">Each piece is meticulously handcrafted using premium materials for exceptional detail and durability.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Expert-Led Workshops</h3>
              <p className="text-gray-600">Learn from master artisans through our immersive in-person and online workshop experiences.</p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Global Community</h3>
              <p className="text-gray-600">Join thousands of passionate miniature enthusiasts in our supportive global community.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Discover our most exquisite hand-painted miniatures, perfect for collectors and enthusiasts. 
              <span className="block mt-2 text-amber-700 font-medium">Limited quantities available!</span>
            </p>
            
            {/* Category Filter */}
            <div className="flex flex-wrap justify-center gap-3 mt-8">
              {['All', 'Fantasy', 'Historical', 'Sci-Fi', 'Architecture'].map((category) => (
                <button 
                  key={category}
              ...
              >
                ...
                {product.originalPrice && product.originalPrice > product.currentPrice ? (
                  <div className="absolute top-3 left-3 bg-red-500 text-white text-xs font-bold px-3 py-1 rounded-full z-10 animate-bounce">
                    SALE {Math.round((1 - product.currentPrice / product.originalPrice) * 100)}%
                  </div>
                ) : (
                ...
                <div className="relative h-56 bg-gradient-to-br from-amber-50 to-amber-100 overflow-hidden">
                  <img
                    ...
                    onError={(e) => {
                      ...
                      target.src = 'https://images.unsplash.com/photo-1605000797499-95a51c5269ae?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2071&q=80';
                    }}
                  />
                ...
                <div className="p-5 flex-1 flex flex-col">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="flex items-center bg-amber-50 text-amber-800 text-xs font-medium px-2 py-1 rounded-full">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 mr-1 text-amber-500" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <p className="text-gray-600 text-sm mb-4 line-clamp-2 flex-grow">
                    {product.description || 'Beautifully handcrafted miniature for your collection.'}
                  </p>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">Explore our latest handcrafted miniatures, just added to the collection.</p>
          </div>
                ...
                <div className="relative h-56 bg-amber-50 overflow-hidden">
                  ...
                  {product.stock && product.stock < 15 && (
                    <div className="absolute top-3 right-3 bg-amber-100 text-amber-800 text-xs font-medium px-2.5 py-1 rounded-full flex items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5 mr-1 animate-pulse" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div className="p-5 flex-1 flex flex-col">
                  <div className="flex justify-between items-start mb-2">
                    <div>
                      ...
                      <p className="text-sm text-amber-600 font-medium">{product.category || 'New Arrival'}</p>
                    </div>
                  ...
                  <div className="mt-auto pt-4 border-t border-amber-100">
                    <div className="flex justify-between items-center">
                      <div>
                        <span className="text-lg font-bold text-gray-900">{formatINR(product.currentPrice)}</span>
                        {product.originalPrice && product.originalPrice > product.currentPrice && (
                          <span className="text-sm text-gray-400 line-through ml-2">
                            {formatINR(product.originalPrice)}
                          </span>
      ...
      <section className="py-20 bg-gradient-to-b from-amber-50 to-white">
        <div className="container mx-auto px-4">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-amber-900/80">
              Don't just take our word for it. Here's what our customers have to say about their MiniCraft Pro experience.
            </p>
          </div>
            ...
            {[
              {
                ...
                content: 'The attention to detail in these miniatures is incredible! I\'ve been collecting for years, and these are some of the finest pieces in my collection.',
                rating: 5,
              ...
              },
              {
                ...
                name: 'Michael Chen',
                role: 'Hobbyist',
                content: 'The workshop was amazing! The instructors were knowledgeable and patient. I learned so much about miniature painting techniques.',
                rating: 5,
              ...
              },
              {
                ...
                name: 'Priya Patel',
                role: 'Gift Buyer',
                content: 'Bought a custom miniature as a gift and the recipient was over the moon! The customization options made it extra special.',
                rating: 4,
              ...
              >
                ...
                <p className="text-gray-600 mb-6 italic relative pl-4 border-l-2 border-amber-200">
                  <span className="absolute -left-3.5 top-0 text-amber-400 text-4xl">"</span>
                  {testimonial.content}
                </p>
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-sm text-gray-500">
                    Purchased: <span className="text-amber-700 font-medium">{testimonial.purchase}</span>
                  </span>
                </div>
              </div>
            ))}
