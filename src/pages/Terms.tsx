    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        <div className="prose max-w-none">
          <p className="mb-4">
            Welcome to E-THORA. These Terms and Conditions outline the rules and regulations
            for the use of PROMETHORA FINTECH SOLUTIONS PVT LTD's website.
          </p>

          <h2 className="text-xl font-semibold mt-8 mb-4">1. Terms of Service</h2>
          <p className="mb-4">
            By accessing this website, you accept these terms and conditions in full. Do not
            continue to use E-THORA's website if you do not accept all of the terms and
            conditions stated on this page.
          </p>

          <h2 className="text-xl font-semibold mt-8 mb-4">2. License to Use Website</h2>
          <p className="mb-4">
            Unless otherwise stated, PROMETHORA FINTECH SOLUTIONS PVT LTD and/or its licensors
            own the intellectual property rights for all material on E-THORA. All intellectual
          ...
          <h2 className="text-xl font-semibold mt-8 mb-4">4. Product Information</h2>
          <p className="mb-4">
